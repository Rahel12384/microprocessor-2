# آزمایش ۱:
خاموش و روشن کردن (چشمک زدن) LED با تناوب ۱ ثانیه
...
delay (1000);
  ...
  ## توضیحات کد  :
  چراغ اول روشن شده بعد از ۱ ثانیه خاموش میشود و چراغ بعدی روشن میشود و از دوباره تکرار میشود


## شماتیک مدار
![توضیح تصویر](repo:Rahel12384/microprocessor-2 )
